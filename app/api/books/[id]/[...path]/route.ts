...
// This catch-all route handles requests like /api/books/{id}/META-INF/container.xml
// and redirects them to /api/books/{id}/epub/META-INF/container.xml
export async function GET(
  ...
  try {
    ...
    try {
      ...
      if (!file) {
        return NextResponse.json(
          { error: `File not found in EPUB: ${filePath}` },
          { status: 404 }
        )
      }
